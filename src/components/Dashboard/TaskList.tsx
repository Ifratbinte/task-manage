  ...
  return (
    <div className="bg-gray-100 p-4">
      ...
      <table className="border-collapse table-fixed w-full text-sm">
        <thead>
          <tr className='border-b dark:border-slate-600 font-medium p-4 pt-0 text-slate-700 dark:text-slate-200 text-left text-base'>
            <th className='pl-8 pb-3'>Title</th>
            <th className='pb-3'>Description</th>
            <th className='pr-8 pb-3'>Due Date</th>
          </tr>
        </thead>
